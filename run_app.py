...
#prompt untuk menjawab pertanyaan
...
question_answer_chain = create_stuff_documents_chain(llm, answer_question_prompt)
...
async def ask_question(request: QueryRequest):
    ...
    try:
        ...
        print(f"Jawaban (Session: {session_id}): {answer}")
        return {"answer": answer}
    except Exception as e:
        print(f"Error saat memproses pertanyaan (Session: {session_id}): {e}")
...
# run app with: uvicorn run_app:app --reload
